...
export default function TransactionsTable() {
  ...
  const [categoriesState, categoriesHandlers] = useListState(
    mockdata.categories
  );
    ...
    <tr key={transaction.id}>
      ...
      <td style={{ position: "relative" }}>
        <TagPicker
          ...
          enableDelete
          onChange={(value) =>
            transactionsHandlers.setItemProp(index, "category", value)
          }
          onTagCreate={(value) => {
          ...
          onTagDelete={(id) =>
            categoriesHandlers.setState(
              categoriesState.filter((c) => c.id !== id)
            )
          }
          onTagUpdate={(id, values) => {
            ...
            transactionsHandlers.setState(
              transactionsState.map((t) =>
                t.category.id === category.id ? { ...t, category } : t
              )
            );
          }}
        />
